...
export const HYATT_BRANDS: HyattBrand[] = [
  ...
  { name: 'Alila', color: '#10B981', segment: 'Luxury' },
  ...
  { name: 'Andaz', color: '#F43F5E', segment: 'Lifestyle' },
  ...
  { name: 'JdV by Hyatt', color: '#EAB308', segment: 'Lifestyle' },
  ...
  { name: 'Grand Hyatt', color: '#1D4ED8', segment: 'Classics' },
  { name: 'Hyatt Regency', color: '#EC4899', segment: 'Classics' },
  { name: 'Hyatt', color: '#EF4444', segment: 'Classics' },
  { name: 'Hyatt Vacation Club', color: '#2563EB', segment: 'Classics' },
  ...
  { name: 'UrCove', color: '#14B8A6', segment: 'Essentials' },
